...
CREATE TABLE categories(id serial primary key,name varchar(150),description text,upvotes integer,downvotes integer);

CREATE TABLE posts(id serial primary key,author varchar(150),source varchar(200),posted_by varchar(150),quote text,expires_on date,upvotes integer,downvotes integer,category_id integer);

CREATE TABLE comments(id serial primary key,say varchar(255),post_id integer);
